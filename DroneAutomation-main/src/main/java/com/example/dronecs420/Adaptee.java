...
import com.example.dronecs420.DroneController;
import com.example.dronecs420.MultiRotorDrone;
//import main.java.surelyhuman.jdrone.util.StreamPlayer;
//import main.java.surelyhuman.jdrone.util.StreamRecorder;


public class Adaptee extends MultiRotorDrone {
	 ...
	 */
	public void initialize() throws SocketException, UnknownHostException, FileNotFoundException {
